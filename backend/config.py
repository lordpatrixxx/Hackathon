...
class Settings:
    ...
    LLM_PROVIDER: str = get_setting("LLM_PROVIDER", "gemini" if os.getenv("GEMINI_API_KEY") else "ollama")
    LLM_MODEL: str = get_setting("LLM_MODEL", "gemini-flash-latest" if os.getenv("GEMINI_API_KEY") else "llama3.2")
